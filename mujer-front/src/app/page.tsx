...
export default function HomePage() {
  ...
  return (
    <main className="min-h-dvh bg-white">
      {/* ✅ FIX móvil: evita cualquier desbordamiento horizontal (cards/badges/gradientes) */}
      <div className="overflow-x-hidden">
        ...
        {/* ✅ Contenedor: seguro en móvil (evita padding que sume > viewport) */}
        <div className="mx-auto w-full max-w-md px-4 sm:px-5 py-8">
          ...
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="mt-1 shrink-0">
              <Dialog open={open} onOpenChange={setOpen}>
                ...
                {/* ✅ FIX móvil: dialog nunca excede viewport y permite scroll interno */}
            ...
            <div className="rounded-[1.5rem] border border-slate-200 bg-white/80 p-4 shadow-sm backdrop-blur">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  {/* ✅ FIX móvil: en pantallas chicas, apila título + badge para que no empuje el ancho */}
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                    <p className="text-sm font-black text-slate-900 break-words">
                      Participación confidencial
                    </p>

                    {/* ✅ FIX móvil: badge no puede “empujar” el contenedor */}
                    <Badge
                      variant="secondary"
                      className={[
          ...
          {/* Texto institucional */}
          <div className="mt-6 rounded-[1.5rem] border border-slate-200 bg-white/70 p-4 text-xs leading-5 text-slate-600 shadow-sm backdrop-blur break-words">
          ...
          <div className="mt-8">
            ...
            <div className="mt-3 flex justify-center gap-4 text-[11px] text-slate-500">
              <Dialog open={privacyOpen} onOpenChange={setPrivacyOpen}>
                ...
                {/* ✅ FIX móvil: dialog también seguro aquí */}
                <DialogContent className="w-[calc(100vw-2rem)] max-w-md max-h-[calc(100dvh-2rem)] overflow-y-auto">
                  <DialogHeader>
        ...
        {/* ✅ Animación para halo del botón (sin afectar layout) */}
        <style jsx global>{`
