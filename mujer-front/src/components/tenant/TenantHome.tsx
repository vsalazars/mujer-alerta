      ...
      <div className="mx-auto w-full max-w-md px-4 sm:px-5 py-8">
            ...
            <Dialog open={open} onOpenChange={setOpen}>
              <DialogTrigger asChild>
                <Button
                  ...
                  aria-label="Acceso"
                  title="Acceso"
                  className="group relative h-11 w-11 rounded-full overflow-hidden transition-all duration-300 ease-out active:scale-[0.97] hover:-translate-y-[1.5px] shadow-[0_6px_18px_rgba(127,1,127,0.28)] hover:shadow-[0_12px_26px_rgba(127,1,127,0.38)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#7F017F]"
                  style={{ background: "linear-gradient(135deg, #7F017F 0%, #BE185D 100%)" }}
                >
                  <span
                    className="pointer-events-none absolute -inset-2 rounded-full blur-md"
                    style={{
                      background: "linear-gradient(135deg, rgba(127,1,127,0.55), rgba(190,24,93,0.45))",
              ...
              <DialogContent className="w-[calc(100vw-2rem)] max-w-md max-h-[calc(100dvh-2rem)] overflow-y-auto">
                <DialogHeader>
                  <DialogTitle style={{ color: BRAND }}>Acceso para el perfil administrador</DialogTitle>
          ...
          <div className="w-full max-w-full rounded-[1.5rem] border border-slate-200 bg-white/80 p-4 shadow-sm backdrop-blur">
            <div className="flex items-start gap-3">
              <div
                ...
                style={{
                  background: "linear-gradient(135deg, rgba(127,1,127,0.15), rgba(190,24,93,0.12))",
              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                  <p className="text-sm font-black text-slate-900 break-words">Participación confidencial</p>
                  <Badge
                    variant="secondary"
          ...
          <div className="w-full max-w-full rounded-[1.5rem] border border-slate-200 bg-white/80 p-4 shadow-sm backdrop-blur">
            <div className="flex items-start gap-3">
              <div
                className="grid h-10 w-10 place-items-center rounded-2xl shrink-0"
                style={{
                  background: "linear-gradient(135deg, rgba(91,33,182,0.14), rgba(127,1,127,0.10))",
                  border: "1px solid rgba(2,6,23,0.06)",
                }}
              >
              ...
              <div className="flex-1 min-w-0">
                <p className="mt-1 text-xs leading-5 text-slate-600 break-words">
                  Verás tres señales del entorno: <span className="font-extrabold text-slate-800">¿qué tan seguido pasa?</span>,{" "}
                  <span className="font-extrabold text-slate-800">¿qué tan normalizado se siente?</span> y{" "}
                  <span className="font-extrabold text-slate-800">¿qué tan grave se percibe?</span>.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-6">
          <Button
            ...
            style={{ background: "linear-gradient(135deg, rgba(127,1,127,1), rgba(190,24,93,0.92))" }}
          >
        ...
        <div className="mt-6 w-full max-w-full rounded-[1.5rem] border border-slate-200 bg-white/70 p-4 text-xs leading-5 text-slate-600 shadow-sm backdrop-blur break-words">
          Herramienta tecnológica basada en análisis de datos para identificar, clasificar y evaluar
          manifestaciones de violencia contra las mujeres en entornos escolar y laboral, con el fin de
          apoyar estrategias de prevención y atención temprana, en concordancia con la{" "}
